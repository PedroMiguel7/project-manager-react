...
class ProjetoDT extends Component {
    ...
    render() {
        ...
        return (
            <>
                <main className='col-11 offset-1 col-lg-11 offset-lg-1 px-5' key={projetos.id_projeto}>
                    <HeaderDt pagina="Projeto" titulo={projetos.nome_projeto} status={projetos.status} />
                    <div className="row gap-3">
                        <div className="CardDT InfoProjeto row py-4">
                            <div className="col-12 col-lg-5 me-4">
                                <h4>Descrição</h4>
                                <p style={{ textAlign: 'justify', fontWeight: 300, lineHeight: '1.6em' }}>{projetos.descricao_projeto}</p>
                            </div>
                        ...
                        <div className="row d-flex gap-4" style={{ maxHeight: "400px" }}>
                            ...
                            <div className="CardDT col">
                                ...
                                <table class="table" style={{ color: 'white' }}>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <BasicModalTarefa id_projeto={projetos.id_projeto} />
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
